...
export const validationSchema = Joi.object({
  ...
  FIREBASE_WEB_API_KEY: Joi.string().allow('').optional(),
  FIREBASE_AUTO_PROVISION: Joi.boolean().truthy('true').falsy('false').default(false),
  FIREBASE_AUTO_PROVISION_ROLE: Joi.string().valid('ADMIN', 'COORDINATOR', 'FIELD_WORKER', 'VOLUNTEER', 'VIEWER').default('ADMIN'),
